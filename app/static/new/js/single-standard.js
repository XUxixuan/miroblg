...
function SendComment() {
	var Toid=window.location.href.split("contact/")[1].split("#")[0]
            ...
            //几个参数需要注意一下
                ...
                url: "/SendComment" ,//url
                data: "ToId="+Toid+"&"+$('#contactForm').serialize(),
                success: function (result) {confirm("SUCCESS")
...
function single_standarad()
{	
	var test = window.location.href;
	data=test.split("contact/");
